...
public class EventsResourceTest {
    ...
    public void testGetAllEventsNoDate() throws Exception {
        List<Event> allEvents = this.resource.getEvents(null, null);
    ...
    public void testGetAllEventsNoDS() throws Exception {
        ...
        this.resource.getEvents(null, null);
    }
    ...
    /*
     * TODO: add a test-case for a violated foreign-key constraint (cf.
     * addDivision in EventsResource). IN order to do this it will be required
     * to enhance the mocking, such that e.g. the id of the 'fake edition' will
     * be matched and a PersistenceException will be thrown in that case.
     */

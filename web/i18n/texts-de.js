...
TRANSLATIONS['de'] = {
		...
		general: {
			...
			requiredFieldsHint: 'Mit Sternchen (*) gekennzeichnete Felder müssen ausgefüllt werden.',
			error: 'Fehler!',
      event: 'Turnier',
      ...
      display: 'Anzeige',
        ...
        alternativeMatchdayNameLabel: 'Bez. für mehrere Termine',
        ...
        localOrganizerPhoneLabel: 'Telefon (optional)',
        eventDisplayName: 'Angezeigter Name',
        divisionsMissing: 'Bitte wähle mindestens eine Division aus, die auf diesem Turnier gespielt werden soll',
        ...
        createNewEditionOrganizer: 'Neuen Ausrichter hinzufügen',
        saveEditionAndContinue: 'Edition speichern und fortfahren',
        saveEvent: 'Turnier speichern',
        editionStep: 'Schritt 1 von 2: Turnier-Edition',
        eventStep: 'Schritt 2 von 2: Turnier',
        editionSaveHint: 'Speichere zuerst die Turnier-Edition. Anschließend kannst du das eigentliche Turnier (Datum, Ort, Divisionen) anlegen und separat speichern.',
        eventStepHint: 'Die Turnier-Edition ist gespeichert. Lege jetzt das eigentliche Turnier an und speichere es mit „Turnier speichern".',
        editionNameMissing: 'Bitte gib einen Namen für die Turnier-Edition ein',
        editionOrganizerMissing: 'Bitte wähle einen Ausrichter aus oder gib den Namen eines neuen Ausrichters ein',
        editionRegistrationPeriodInvalid: 'Bitte gib einen gültigen Registrierungszeitraum an (das Ende darf nicht vor dem Beginn liegen)',
 			},
		},
		...
		team: {
			...
			roster: {
				...
				empty: 'Keine Spieler:innen hinzugefügt',
				remove: 'Roster löschen',
				editTooltip: 'Roster Info bearbeiten',
				editPlayersTooltip: 'Spieler:innen hinzufügen / löschen',
				...
				notLoggedIn: 'Spieler:innen sind nur für angemeldete Benutzer sichtbar',
